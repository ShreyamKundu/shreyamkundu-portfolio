        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex gap-6 justify-center items-center md:justify-start">
            ...
            {/* <a 
              ...
              className="flex items-center font-medium text-[#64b5f6] hover:text-[#9acff9] transition-colors " 
              aria-label="Resume"
            >
              resume <GoArrowUpRight size={18} />
            </a> */}
            <a
              href="https://drive.google.com/file/d/1Y8vD5Y1SLBTye1VNPK8g1Kc-uz3Yz3mk/view?usp=drive_link"
              className="flex flex-col items-center text-[#9ba1a6] hover:text-[#64b5f6] transition-colors"
              aria-label="Resume"
            >
              ...
              <div className="w-full border-t-2 border-dashed border-[#9ba1a6]"></div>
            </a>
          </div>
        </div>
      </div>
