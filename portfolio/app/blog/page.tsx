...
import { GitCommitCounter } from "@/components/git-commit-counter";
...
export default function BlogPage() {
  ...
  return (
    <>
      {/* Description Section - Similar to "Currently" section */}
      <section className="mb-24">
        ...
        >
          ...
          <p className="text-zinc-400">
            A collection of articles, tutorials, and insights from my journey as
            a developer. Sharing knowledge and experiences to help fellow
            developers.
          </p>
        </motion.div>
      </section>
